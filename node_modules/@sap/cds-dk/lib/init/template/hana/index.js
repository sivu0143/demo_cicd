...
module.exports = class HanaTemplate extends require('../../plugin') {
    ...
    async combine() {
        const project = readProject()
        const { addMta, addHelm, addHelmUnifiedRuntime, addMultitenancy, addContainerize, isJava, hasHelm, hasMultitenancy, srvPath } = project
        ...
        if (addContainerize && !hasMultitenancy) {
            const additions = [{
                in: 'modules',
